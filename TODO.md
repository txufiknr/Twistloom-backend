...
please examine my ending advancement implementation which called before each AI page generation turn
...
finally, can you enhance thriller story page prompting effectiveness?
`buildEndingRules` function
