export const CHARACTER_NAMES = {
  ...
  femaleNames: [
    ...
    'Anna', 'Caroline', 'Genesis', 'Emilia', 'Kennedy', 'Samantha', 'Maya',
    'Kinsley', 'Naomi', 'Aaliyah', 'Elena', 'Sarah', 'Ariana', 'Allison', 'Kara',
    'Gabriella', 'Alice', 'Madelyn', 'Cora', 'Ruby', 'Eva', 'Seraphina', 'Lucien',
    'Rose', 'Iris', 'Hazel', 'Ivy', 'Ruby', 'Dawn', 'Skye', 'Wren', 'Clara', 'Carla',
    'Poppy', 'Briar', 'Fern', 'Olive', 'Jade', 'Pearl', 'Orla', 'Elara', 'Hermione',
    ...
    'Ophelia', 'Cassia', 'Seraphine', 'Evangeline', 'Genevieve', 'Maxine',
    ...
    'Kaia', 'Nyla', 'Zara', 'Veda', 'Sia', 'Kora', 'Mila', 'Nia',
