...
export function mapToPersistedStoryPage(dbPage: DBPage): PersistedStoryPage {
  return {
    ...
    imagePrompt: dbPage.imagePrompt || undefined,
    imageImportance: dbPage.imageImportance ?? undefined,
    imageUrl: dbPage.imageUrl || undefined,
...
export function mapBookFromDb(dbBook: DBBook): Book {
  return {
    ...
    aiContributionPercent: dbBook.aiContributionPercent ?? null,
