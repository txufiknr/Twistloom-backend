 ...
 * prompt const (`PEN_STATE_PROPOSAL_SYSTEM`) plus a user prompt with the
 * stable-per-session sections first, then the per-page canon/prose and the
 * current inventory/injuries last.
 */
