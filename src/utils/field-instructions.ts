...
${isLatePhase || isFinale ? `  - A sudden shift can heighten dread — but don't reuse it as a cheap scare every page.` : ''}` },
  { fields: ['imagePrompt', 'imageImportance'], stage: 'page', text: `imagePrompt, imageImportance (optional, omit both if this page has nothing worth drawing)
  - imagePrompt: ALWAYS write in ENGLISH regardless of the story's language. One to two sentences, concrete and filmable: character appearance/pose, setting, lighting/atmosphere, one key object or symbol. Evocative and atmospheric to match this story's tone — suggestion and mood over explicit gore.
